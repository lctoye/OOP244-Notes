...
int OrderTests(const Prefix& list, int& testNo, int* passed, int* tested) {
    ...
    //
    if(order.has(EAN()) == 0) {
        testFailed("Order(), has(EAN()) did not return true", ++testNo,
         &ok, tested);
    } else
    ...
    if(order.has(EAN("9789070002046", list)) == 0 || order.outstanding() != 0) {
    ...
    order = Order(EAN("9789070002046", list));
    order.add(5);
    if(order.has(EAN("9789070002046", list)) == 0 || order.outstanding() != 5) {
        testFailed("has(EAN(\"9789070002046\", )), outstanding()",
         ++testNo, &ok, tested);
    } else
        testPassed("has(\"9789070002046\"), outstanding()", ++testNo, passed,
    ...
    if(order.has(EAN("9789070002043", list)) == 0 || order.outstanding() != 0) {
    ...
    order.add(5);
    if(order.has(EAN("9789070002043", list)) == 0 || order.outstanding() != 0) {
        testFailed("has(EAN(\"9789070002043\", )), add(5), outstanding()",
         ++testNo, &ok, tested);
    } else
        testPassed("has(\"9789070002043\"), add(5), outstanding()", ++testNo, passed,
         tested);
